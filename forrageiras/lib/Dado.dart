class Dado{
  ...
  Dado(){
     orden.addAll(["PRODUTIVIDADE","PROPAGACAO","FERTILIDADE","TOL. ACIDEZ","TOL. SECA","TOL. FRIO ","SOLO ENCHARCADO","RESIST. CIGARRINHA","ESTABELECIMENTO","RELEVO","USO","TOL. SOMBREAMENTO","ANIMAL","CULTIVAR"]);
